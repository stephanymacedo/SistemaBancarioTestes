...
public class GerenciadoraClientesTest_Ex10 {
	...
	public void setUp() {
		...
		Cliente cliente01 = new Cliente(idCLiente01, "Stephany Macedo", 31, "Stephanymacedo@gmail.com", 1, true);
		Cliente cliente02 = new Cliente(idCLiente02, "Heitor Macedo", 34, "heitormacedo@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel() throws IdadeNaoPermitidaException {
		...
		/*Montagem do Cenário*/		
		Cliente cliente = new Cliente(1, "Stephany", 25, "Stephany@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_02() throws IdadeNaoPermitidaException {
		...
		/*Montagem do Cenário*/		
		Cliente cliente = new Cliente(1, "Stephany", 18, "Stephany@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_03() throws IdadeNaoPermitidaException {
		...
		/*Montagem do Cenário*/		
		Cliente cliente = new Cliente(1, "Stephany", 65, "Stephany@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_04() throws IdadeNaoPermitidaException {
		...
		/*Montagem do Cenário*/		
		Cliente cliente = new Cliente(1, "Stephany", 17, "Stephany@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_05() throws IdadeNaoPermitidaException {
		...
		/*Montagem do Cenário*/		
		Cliente cliente = new Cliente(1, "Stephany", 66, "Stephany@gmail.com", 1, true);
		/*Execução*/
		try {
			gerClientes.validaIdade(cliente.getIdade());
			fail();
